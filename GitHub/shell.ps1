...
if ($env:github_shell -eq $null) {
  ...
  $appPath = Resolve-Path "$env:LocalAppData\Apps\2.0\DDQ9A9OQ.K9R\19GY16R0.8KC\gith..tion_317444273a93ac29_0003.0000_20a3dfa4ba8ba894"
  $msBuildPath = "$env:SystemRoot\Microsoft.NET\Framework\v4.0.30319"

  $env:Path = "$env:Path;$pGitPath\cmd;$pGitPath\usr\bin;$pGitPath\usr\share\git-tfs;C:\Users\Amit\AppData\Local\GitHub\lfs-amd64_1.1.0;$appPath;$msbuildPath"
